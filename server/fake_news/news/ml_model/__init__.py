...
from news.ml_model.models.gru import GRULime
from news.ml_model.models.logistic_regression_feature import \
    LogisticRegressionModelFeature
from news.ml_model.models.xgb import XGBoostLime
from scipy.sparse import hstack
from sklearn.pipeline import Pipeline
from sklearn.preprocessing import normalize

from news.ml_model.utils.gru_utils import nltk_corpus_download
from news.ml_model.models.gru_feature import GRUVectorizer
from news.ml_model.models.xgb_feature import XGBoostVectorizer
...
log_model_feature = LogisticRegressionModelFeature(xgb_pipeline, gru_pipeline)
...
def combine_sentence(headline, body):
    return '%s %s %s' % (headline, SPLIT_CHARACTER, body)
...
def classifier_fn(text_list):
    ...
    for text in text_list:
        ...
        ret.append(full_pipeline.predict_proba([[sentence1, sentence2]])[0])
